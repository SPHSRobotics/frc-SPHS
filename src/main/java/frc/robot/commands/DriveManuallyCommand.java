...
// and so on.
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////
      ...
      boolean buttonUR = Robot.oi.rightStick.getRawButton(3);
      boolean buttonBR= Robot.oi.rightStick.getRawButton(2);
      boolean buttonBL = Robot.oi.rightStick.getRawButton(1);
      ...
      if(buttonXFast)
        ...
        Robot.driveSubsystem.manualDrive(left, right, buttonUR, buttonBL, buttonBR,
